...
<html>
	<head>
		...
		<link rel="stylesheet" href="/Moffat-Bay/css/LookupSummary.css">
			...
			<section class="col-12 col-sm-6 col-md-5">
				<form class="form-container">
					...
					<div class="button-group">
						<a href="/Moffat-Bay/jsp/Landing/LandingPage.jsp"><button type="button" class="btn btn-outline-success w-100">Okay</button></a>
					</div>
				</form>
			</section>
		</section>
